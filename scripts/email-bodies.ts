 ...
 * the offer shown on smartflowdev.com/chatbot so there's no price gap
...
<p style="margin:0 0 14px 0">Quick one — your site doesn't have a way for someone with toothache at 11pm to book an appointment without calling. We build that in 5 days.</p>
...
<p style="margin:0 0 14px 0">Gyors kérdés — az oldalukon nincs mód arra, hogy egy 23 órakor fogfájó páciens időpontot foglaljon hívás nélkül. 5 nap alatt megépítjük.</p>
...
const DE_BODY = (companyRaw: string): string => {
  ...
  return `<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:560px;margin:0 auto;color:#2b2b2b;line-height:1.65;font-size:15px">
<p>Hallo ${c} Team,</p>
<p>Kurz: Auf Ihrer Website kann niemand mit Zahnschmerzen um 23 Uhr einen Termin buchen, ohne anzurufen. Wir bauen das in 5 Tagen.</p>
...
<p>Rápido: su sitio no permite que alguien con dolor de muelas a las 11pm reserve sin llamar. Lo construimos en 5 días.</p>
